...
class LocationController extends GetxController implements GetxService {
  ...
  final List<String> _addressTypelist=["home", "office", "home"];
  ...
  Position get pickPostion=>_pickPostion;
  // for service zone 
  ...
  bool _buttonDisabaled=true;
  bool get buttonDisabaled => _buttonDisabaled;

  // Save the google map suggestion for adrress
  List<Prediction> _predictionList = [];

  void setMaController(GoogleMapController mapController)
  {
      ...
      try {
        if (fromAddress) {
          _position=Position(
            ...
            altitude: 1,
            speedAccuracy: 1,
            speed: 1, altitudeAccuracy: 3, headingAccuracy: 3
          );
        }else{
        ...
        _buttonDisabaled=!_responseModel.isSuccess;
        if (_changeAddress) {
  ...
  async {
    ...
    if (response.body["status"]=='OK') {
     ...
     // print("Pringting address:::::"+_address);
    }else{
  ...
  Future<ResponseModel> addAddess(AddressModel addressModel) async {
    _loading = true;
    update();
 ...
 void setAddAddressData(){
  ...
  Future<ResponseModel> getZone(String lat, String lng, bool markerLoad) async {
    ...
    print("zone response code is: "+response.statusCode.toString());//200:404
    update();
 ...
 Future<List<Prediction>> searchLocation(BuildContext context, String text) async {
  ...
  setLocation(String placeID, String address, GoogleMapController mapController)
  async {
    _loading=true;
    update();
