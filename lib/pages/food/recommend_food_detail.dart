      ...
      body: CustomScrollView(
        slivers: [
          SliverAppBar(
            ...
            pinned: true,
            backgroundColor: Color.fromARGB(255, 247, 120, 120),
            expandedHeight: 300,
                  ...
                  children: [
                    GestureDetector(
                      ...
                      child: AppIcon(
                        ...
                        backgroudColor: Color.fromARGB(255, 15, 215, 222),
                        icon: Icons.remove),
                    ),
                      BigText(text: "\$ ${product.price!} X  ${controller.inCartItem} ",color: Colors.black87,size: Dimensions.font26,),
                    GestureDetector(
                      onTap: () {
                ...
                child: Row(
                  ...
                  children: [
                    Container(
                      ...
                      child: Icon(
                        Icons.favorite,
                        color: Color.fromARGB(255, 21, 223, 223),
                      ),
                    ),
                    GestureDetector(
                      onTap: () {
