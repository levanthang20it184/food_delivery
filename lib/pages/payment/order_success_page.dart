      ...
      body: Center(
        child: SizedBox(
          ...
          child: Column(
            ...
            children: [
              Icon(status == 1 ? Icons.check_circle_outline_outlined : Icons.warning_amber_outlined, size: 100, color: Color.fromARGB(255, 33, 198, 243),),
              SizedBox(
              ...
              Padding(
                ...
                child: CustomButton(
                  ...
                  onPressed: () => Get.offNamed(RouterHelper.getInitial()),
                ),
              ),
              SizedBox(
                height: Dimensions.height10,
