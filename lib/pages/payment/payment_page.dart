...
import '../../until/app_constants.dart';
...
class _PaymentPageState extends State<PaymentPage> {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          backgroundColor: Color.fromARGB(255, 33, 243, 243),
        ),
        body: Center(
          child: Container(
  ...
  void _redirect(String url) {
    ...
    if(_canRedirect) {
      ...
      if (_isSuccess) {
        Get.offNamed(RouterHelper.getOrderSuccessPage(widget.orderModel.id.toString(), 'success'));
      } else if (_isFailed || _isCancel) {
        Get.offNamed(RouterHelper.getOrderSuccessPage(widget.orderModel.id.toString(), 'fail'));
      }else{
